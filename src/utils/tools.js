export const getChildren = (arr, pid, pidKey) => {
    let result = [];
...
export const mapChildren = (arr, result, pidKey, idKey) => {
    if (result.length === 0) {
        return
    }
 ...
 */
export const sortBy = (arr, attr, order = 'asc') => {
 ...
 * @returns {Array}
 */
export const formatTree = (arr, rootId, idKey, pidKey) => {
    let result = [];
    for (let i = 0; i < arr.length; i++) {
 ...
 * @return {Promise<any>}
 */
export const imgLoad = (imgElement) => {
 ...
 * @return {Promise<*|File>}
 */
export const compressImage = (imgFile, scale = 1) => {
 ...
 * @return {Promise<*|File>}
 */
export const compressImageSize = (imgFile, maxSize = 100 * 1024, isFixSize = true) => {
